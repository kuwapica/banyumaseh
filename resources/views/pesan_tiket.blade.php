                            ...
                            <div class="list-group-item border-0 px-0 py-2">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="small text-muted mb-0">Pembatalan dapat dilakukan maksimal H-1
                                            sebelum
                                            tanggal kunjungan.</p>
                                    </div>
                                </div>
                        ...
                        <div class="card h-100 border-0 shadow-sm overflow-hidden">
                            <div class="position-relative overflow-hidden" style="height: 200px;">
                                ...
                                <div class="position-absolute bottom-0 start-0 end-0 p-3"
                                    ...
                                    <p class="text-warning mb-0">Rp
                                        {{ number_format($destinasi->price, 0, ',', '.') }} /
                                        tiket</p>
                                </div>
                            </div>
                            <div class="card-body">
                                <p class="card-text text-muted mb-3">{{ Str::limit($destinasi->description, 120) }}
                                </p>
