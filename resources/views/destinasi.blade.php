...
@section('title', 'Destinasi - Banyumas Tourism')
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('destinasi.index') }}" id="filterForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Masukkan nama destinasi..." 
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['sort' => 'name', 'order' => 'asc']) }}">
                            <i class="fas fa-sort-alpha-down me-2"></i>Nama A-Z
                        </a></li>
                        <li><a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['sort' => 'name', 'order' => 'desc']) }}">
                            <i class="fas fa-sort-alpha-up me-2"></i>Nama Z-A
                        </a></li>
                        <li><a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['sort' => 'rating', 'order' => 'desc']) }}">
                            <i class="fas fa-star me-2"></i>Rating Tertinggi
                        </a></li>
                        <li><a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['sort' => 'price', 'order' => 'asc']) }}">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                            <div class="card h-100 shadow-sm destination-card">
                                ...
                                <div class="position-relative">
                                    <img src="{{ $destination->image ? asset('images/' . $destination->image) : 'https://via.placeholder.com/400x250?text=No+Image' }}" 
